...
export default function BillionsItem({ initialBillions }: billionProps) {
  const { id, squareImage, name, industries } = initialBillions;
  ...
  return (
    <Link href={`/person/${id}`} className="flex flex-col gap-2">
      <div className="relative aspect-square flex items-center justify-center border border-neutral-400 rounded-lg">
        ...
        {/* {squareImage && <Image fill src={squareImage} alt={name} />} */}
      </div>
